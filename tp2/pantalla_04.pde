void pantalla4(){
String t = "NANO SHINONOME";
String tt = "Es una androide ansiosa creada por la profesora Hakase con quien vive y a quien cuida. Intenta vivir como una chica normal.";
...
// Texto
fill(147, 224, 99, opacidadTextos);
textFont(titulos);
text(t, 40, 205);
